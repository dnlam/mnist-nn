...
def run_softmax_on_MNIST_mod3(temp_parameter=1):
    ...
    # YOUR CODE HERE
    train_x, train_y, test_x, test_y = get_MNIST_data()
    train_y,test_y = update_y(train_y=train_y,test_y=test_y)
...
print('softmax test_pcr_error=', test_error)
...
theta, cost_function_history = softmax_regression(train_cube, train_y, 1, alpha=0.3, lambda_factor=1.0e-4,
                                                      k=10, num_iterations=150)
plot_cost_function_over_time(cost_function_history)
test_error = compute_test_error(test_cube, test_y, theta, 1)
print('softmax test_pca10_cubic_error=', test_error)